...
#exec Texture Import File=Textures\S_SceneManager.bmp  Name=S_SceneManager Mips=Off

// Graphics for UI
#exec Texture Import File=Textures\S_MatineeIP.bmp Name=S_MatineeIP Mips=Off MASKED=1
#exec Texture Import File=Textures\S_MatineeIPSel.bmp Name=S_MatineeIPSel Mips=Off MASKED=1
#exec Texture Import File=Textures\S_MatineeTimeMarker.bmp Name=S_MatineeTimeMarker Mips=Off MASKED=1
#exec Texture Import File=Textures\S_ActionCamMove.bmp  Name=S_ActionCamMove Mips=Off
#exec Texture Import File=Textures\S_ActionCamPause.bmp  Name=S_ActionCamPause Mips=Off
#exec Texture Import File=Textures\S_PathLinear.bmp  Name=S_PathLinear Mips=Off MASKED=1
#exec Texture Import File=Textures\S_PathBezier.bmp  Name=S_PathBezier Mips=Off MASKED=1
#exec Texture Import File=Textures\S_BezierHandle.bmp  Name=S_BezierHandle Mips=Off MASKED=1
#exec Texture Import File=Textures\SubActionIndicator.bmp  Name=SubActionIndicator Mips=Off MASKED=1
