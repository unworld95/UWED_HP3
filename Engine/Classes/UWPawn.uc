class UWPawn extends Pawn placeable;
...
function BlockedBySwingingDoor(SwingingDoor BlockingDoor);

function bool RelocatePawn (Vector Loc)
{
    return FancySetLocation(Loc);
}

function UWPawn GetAlternatePickupActor ()
{
    return None;
}
...
{
    return DoJump(bUpdating);
}

//Custom UW function - stub for native function
