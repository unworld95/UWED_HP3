...
var(Menu) config string MidGameMenuClass; // Menu that is shown when Escape is pressed (Runtime)
...
exec function ShowMenu()
{
	...
	// Open menu
	ClientOpenMenu(MidGameMenuClass); //Added by Demiurge (Runtime) (make menus work)
}
...
defaultproperties
{
     ...
     MidGameMenuClass="RTInterface.MidGameMenu"
     FovAngle=85.000000
     Handedness=1.000000
     bIsPlayer=True
     bCanOpenDoors=True
