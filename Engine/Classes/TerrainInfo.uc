...
#exec Texture Import File=Textures\S_TerrainInfo.bmp Name=S_TerrainInfo Mips=Off MASKED=1
#exec Texture Import File=Textures\S_WhiteCircle.bmp Name=S_WhiteCircle Mips=Off MASKED=1
#exec Texture Import File=Textures\TerrainBad.bmp Name=TerrainBad Mips=Off
