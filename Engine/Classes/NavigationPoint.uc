...
#exec Texture Import File=Textures\S_Pickup.bmp Name=S_Pickup Mips=Off MASKED=1
#exec Texture Import File=Textures\S_Pickup.bmp Name=S_NavP Mips=Off MASKED=1

// not used currently
#exec Texture Import File=Textures\S_Alarm.bmp Name=S_Alarm Mips=Off MASKED=1
