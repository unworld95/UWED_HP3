...
#exec Texture Import File=Textures\S_LockLocation.bmp Name=S_LockLocation Mips=Off MASKED=1
#exec Texture Import File=Textures\S_AutoAlignToTerrain.bmp Name=S_AutoAlignToTerrain Mips=Off MASKED=1
