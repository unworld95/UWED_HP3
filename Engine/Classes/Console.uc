...
// Removed by Demiurge (Runtime)
//#exec TEXTURE IMPORT NAME=ConsoleBK FILE=..\UWindow\TEXTURES\Black.bmp	
//#exec TEXTURE IMPORT NAME=ConsoleBdr FILE=..\UWindow\TEXTURES\White.bmp	
...
state Typing
{
	...
	function PostRender(Canvas Canvas)
	{
		...
		//Canvas.DrawTile( texture 'ConsoleBk', Canvas.ClipX, yl+6,0,0,32,32); Commented out by Demiurge (Runtime)

		Canvas.SetPos(0,Canvas.ClipY-8-yl);	
		Canvas.SetDrawColor(0,255,0);
		// Canvas.DrawTile( texture 'ConsoleBdr', Canvas.ClipX, 2,0,0,32,32); Commented out by Demiurge (Runtime)
