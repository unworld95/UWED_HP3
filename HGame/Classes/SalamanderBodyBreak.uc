Class SalamanderBodyBreak extends CreatureFX;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter12
         ...
         StartSizeRange=(X=(Min=2.000000,Max=10.000000),Y=(Min=2.000000,Max=5.000000),Z=(Min=2.000000,Max=5.000000))
         UniformSize=True
     ...
     End Object
     Emitters(0)=SpriteEmitter'HGame.SalamanderBodyBreak.SpriteEmitter12'
     Begin Object Class=MeshEmitter Name=MeshEmitter2
         ...
         StartSizeRange=(X=(Max=0.500000),Y=(Max=4.000000))
         InitialParticlesPerSecond=150.000000
         Texture=Texture'HP3_Gameplay.Spell_Objects.Pumpkin'
         LifetimeRange=(Min=1.500000)
         StartVelocityRange=(X=(Min=-100.000000,Max=100.000000),Y=(Min=-100.000000,Max=100.000000),Z=(Min=80.000000,Max=300.000000))
         Name="MeshEmitter2"
     End Object
     Emitters(1)=MeshEmitter'HGame.SalamanderBodyBreak.MeshEmitter2'
     bDirectional=True
}
