Class SpawnFlashViolet extends SpawnFlash;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter54
         ...
         UseColorScale=True
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=255,G=53,R=154))
     ...
     End Object
     Emitters(0)=SpriteEmitter'HGame.SpawnFlashViolet.SpriteEmitter54'
}
