Class WizardCardPickup extends Pickups;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         Acceleration=(X=20.000000,Y=20.000000,Z=2.000000)
         UseColorScale=True
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=155,G=55,R=120,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=222,G=12,R=28))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=149,G=45,R=71,A=255))
         FadeOutStartTime=1.500000
         FadeOut=True
         MaxParticles=33
         StartLocationOffset=(X=24.000000,Y=24.000000,Z=-5.000000)
         ...
         Name="SpriteEmitter2"
     End Object
     Emitters(0)=SpriteEmitter'HGame.WizardCardPickup.SpriteEmitter2'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter14
         Acceleration=(X=5.000000,Y=5.000000,Z=-256.000000)
         UseColorScale=True
         ...
         StartLocationRange=(X=(Min=-24.000000,Max=24.000000),Y=(Min=-24.000000,Max=24.000000),Z=(Min=-5.000000,Max=5.000000))
         ...
         StartVelocityRange=(X=(Min=-36.000000,Max=36.000000),Y=(Min=-36.000000,Max=36.000000),Z=(Min=128.000000,Max=200.000000))
         UseVelocityScale=True
         Name="SpriteEmitter14"
     End Object
     Emitters(1)=SpriteEmitter'HGame.WizardCardPickup.SpriteEmitter14'
}
