Class TopiaryBadgerSpwn extends Hpgenericspawner;

defaultproperties
{
     bBlocksCamera=True
     vulnerableToClass=Class'HGame.DepulsoSpell'
     SpawningSound(0)=Sound'SoundEffects.Objects.topiary_badger'
     GoodieToSpawn(0)=Class'HGame.Jellybean'
     SpawningAnim="Hit"
     Emitts=(Spawning=Class'HGame.LeavesBurst',StartPos=(Z=20.000000))
